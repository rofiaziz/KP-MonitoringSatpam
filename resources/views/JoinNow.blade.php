...
<body>
  <div class="container-fluid JoinNow-Hero">
    <div class="row" style="padding-top:3rem;padding-bottom:3rem">
      <div class="col-md-6">
        <div class="card card-borderRound">
          <h5 class="card-title Title">Bergabung Sekarang</h5>
          <div class="card-body">
            <div class="container">
              ...
              <form>
                ...
                <div class="row">
                  <div class="update ml-auto mr-auto">
                    <button type="submit" class="btn btn-primary btn-round buttonbackground"
                      style="width:20rem; font-size:19px">Daftar</button>
                  </div>
                </div>
              </form>
            </div>
